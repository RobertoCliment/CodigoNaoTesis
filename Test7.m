...
while(Xtk(1)>0.05)
    ...
    %Gráfica de la diferencia entre D (flujo divergente estimado) con ruido y D sin ruido
    figure(1)
    ...
    %Gráfica de la diferencia entre la dimensión X de la pelota con ruido y sin ruido
    figure(2)
    title('Diferencia entre la dimensión X de la pelota con ruido y sin ruido')
    plot(i*DeltaT, XpelotaAct-XpelotaActRuido, '*b')
    axis([0 10 -0.21 0.21])
    hold on
    
    %Gráfica de la diferencia entre la dimensión Y de la pelota con ruido y sin ruido
    figure(3)
    title('Diferencia entre la dimensión Y de la pelota con ruido y sin ruido')
