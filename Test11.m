%%Este script guarda en tun txt las variables
...
while(Xtk(1)>0.4)
    ...
    %La variable Store guarda los datos de cada iteración
    Store1(i,1)=Xtk(1);
    Store1(i,2)=Xtk(2);
    Store1(i,3)=M;
    Store1(i,4)=r;
    Store1(i,5)=Dest;
    Store1(i,6)=Xtk(2)/Xtk(1);
    Store1(i,7)=Dest-Xtk(2)/Xtk(1);
    Store1(i,8)=ErrorActual;
    Store1(i,9)=ErrorTotal;
    Store1(i,10)=F(1,1);
    Store1(i,11)=F(1,2);
    Store1(i,12)=F(2,1);
    Store1(i,13)=F(2,2);
...
%Se guarda en el archivo txt toda la información
save('DatosSim.txt','Store1','-ascii')